...
- Result: pass. 211/211 passed, 0 failed, 0 skipped, exit 0 (review-fix iter-01, over HEAD 7566611 plus this commit's test edits)
- Lint / build: lint (`git diff --cached --check`) pass. Build (`node .asd/sync.js --check`) pass: exit 0
- Entry 2 record: 211/211 at 9452acf
