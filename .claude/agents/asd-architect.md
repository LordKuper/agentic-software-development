...
- ADR: per `t_adr.html`
- c4 model: LikeC4 DSL per upstream spec
- Audit code section: feeds `t_audit.md` "Existing implementation found", "Gaps", "Risks", "Subsystems map"
- stack.html: per `t_stack.html`
- api.html: per `t_api.html`
